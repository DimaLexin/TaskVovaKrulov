...
switch (cod) {
    ...
    case '9' :  
                ...
                let output ="Пары 'ключ-значения' объекта выглядят так: "
                for (let key in newObj) {
                    output = output + key + ":" + newObj[key] + ",";
                };
                   console.log(output.slice(0,-1));

    break;
    case '10' :  function MyObj (x,y,z) {
                    this.name = x;
                    this.surname = y;
                    this.dateOfBirth = z;
                    this.setPop = function (strKey, value, newObj) {
                    }                
                }
                function MyObj (x,y,z) {
                    this.name = x;
                    this.surname = y;
                    this.dateOfBirth = z;
                    this.setPop = function (strKey, value, newObj) {
